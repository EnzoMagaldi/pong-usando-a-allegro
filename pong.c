...
void start_game() {
    ...
    ALLEGRO_BITMAP *background = NULL;  // Variável para a imagem de fundo
    bool done = false;
    bool redraw = true;
    ...
    al_init_image_addon();  // Adiciona suporte para imagens
    ...
    background = al_load_bitmap("teste basico.jfif");
    if (!background) {
    ...
    al_destroy_bitmap(background);  // Liberar a imagem de fundo
